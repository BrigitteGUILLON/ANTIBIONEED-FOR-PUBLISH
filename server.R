...
if (difday>-1)  {UTILISATEUR(TRUE)}
  ...
  if(ALGO2 == T)
    ...
    # function to generate a code for each pdf generate 
    # The code date hour login is saved in a table on server side 
    # This unique code permits to find the pdf generated by a specific center 
