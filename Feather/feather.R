...
# fichier en provenance de ANOUK 
...
write_feather(read.xlsx(paste0(labaseTT,"resBR.xlsx"),sheetName  ="ALGO1_Reco"),paste0(FeatherDir,"BRB.feather"))

write_feather(read.xlsx(paste0(labaseTT,"resBR.xlsx"),sheetName ="ALGO2"),paste0(FeatherDir,"ALGO2BR.feather"))


write_feather(read.xlsx(paste0(labaseTT,"resBR.xlsx"),sheetName ="RECOCOND"),paste0(FeatherDir,"RECOCONDBR.feather"))
# 
...
View(ListecodesServeur)



# Liste randomisations 
